...
<head>
    <meta charset="utf-8">
    <title>Admin - Dimensi Hair Studio</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="{{ route('dashboard.index') }}" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>D HairStudio</h3>
                </a>
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="{{ route('pemesanan.index') }}" class="dropdown-item">Pemesanan</a>
                            <a href="{{ route('testimoni.index') }}" class="dropdown-item">Testimoni</a>
                        </div>
                    </div>
                </div>
            </nav>
